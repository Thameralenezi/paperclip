...
import { printKimiCodeStreamEvent } from "@paperclipai/adapter-kimi-code/cli";
...
const kimiCodeCLIAdapter: CLIAdapterModule = {
  type: "kimi_code",
  formatStdoutEvent: printKimiCodeStreamEvent,
};
