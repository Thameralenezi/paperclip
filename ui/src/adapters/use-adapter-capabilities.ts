...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  kimi_code: { supportsInstructionsBundle: true, supportsSkills: true, supportsLocalAgentJwt: true, requiresMaterializedRuntimeSkills: false, supportsModelProfiles: false },
